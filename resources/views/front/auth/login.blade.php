      ...
      <div class="col-12">
        ...
        <nav class="navbar navbar-expand-lg blur border-radius-sm top-0 z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
          <div class="container-fluid px-1">
            <a class="navbar-brand font-weight-bolder ms-lg-0 " href="{{ route('index') }}">
              Corporate UI
            </a>
            ...
            <div class="collapse navbar-collapse text-end" id="navigation">
              <ul class="navbar-nav d-lg-block d-none ">
                <li class="nav-item">
                  <a class="btn btn-sm mb-0 bg-gradient-dark">Free download</a>
                </li>
              </ul>
            </div>
          </div>
              ...
              <div class="card card-plain">
                ...
                <div class="card-body">
                    <div class="cartoon-container d-flex justify-content-center">
                        <svg class="mySVG" height="250px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 200 200">
                            <defs>
