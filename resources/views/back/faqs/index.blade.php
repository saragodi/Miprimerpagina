...
@section('title')
    <div class="d-sm-flex align-items-center justify-content-between mg-lg-b-30">
        ...
        <div class="d-none d-md-block">
            <a href="javascript:void(0)" data-toggle="modal" data-target="#modalCreateFAQ"
                class="btn btn-sm btn-primary btn-uppercase"><i class="fas fa-plus"></i> Agregar Pregunta frecuente</a>
        </div>
    </div>
@endsection
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap">
                                    <a href="javascript:void(0)" class="btn btn-outline-primary btn-sm btn-icon"
                                        ...
                                        data-target="#editFAQ_{{ $question->id }}">
                                ...
                                <div class="modal-dialog modal-dialog-vertical-center" role="document">
                                    <div class="modal-content bd-0 tx-14">
                                        <div class="modal-header">
                                            <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Editar Pregunta
                                                Frecuente</h6>
