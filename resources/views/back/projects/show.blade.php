...
@section('content')
    <div class="row mb-4">
        <div class="col-md-6 text-left">
            <a href="{{ route('projects.index') }}" class="btn btn-info mr-2"><i class="simple-icon-arrow-left"
                    aria-hidden="true"></i> Regresar</a>
        </div>

        <div class="col-md-6 text-right">
            <a href="{{ route('projects.edit', $project->id) }}" class="btn btn-primary mr-2"><i
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col">
                                    <h5>Imagen</h5>
                                    <div class="card">
                                        <p class="badge badge-primary">Identificador de base de datos: {{ $project->id }}
                                        </p>
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <div class="d-flex">
                        <div class="card-project d-flex position-relative justify-content-center align-items-center"
                            id="hex_" style="background: {{ $project->hex }}">
                            <div class="card-project-content">
                                <h5 id="title_">{{ $project->title }}</h5>
